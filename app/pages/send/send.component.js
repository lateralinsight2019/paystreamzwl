	...
	getAssetDescription(asset) {
		if (asset.asset_type !== 'native') {
			if (asset.asset_code in this.assetCodeCollisions) {
				console.log('send.component.js getAssetDescription if asset block');
				return `${asset.asset_code}.${asset.asset_issuer}`;
			} else {
				console.log('send.component.js getAssetDescription else asset block');
				return asset.asset_code;
			}
		} else {
			console.log('send.component.js getAssetDescription else nativecode block')
			return 'XLM';
		}
	}
